...
@section('content')
    ...
    <div id="modalTambah" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-50 p-4">
        <div class="bg-white rounded-xl p-6 w-full max-w-lg">
            ...
            <form action="{{ route('staf.informasi.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <script>
        ...
        function openDetail(id) {
            ...
            `;
                    ...
                    document.getElementById('hapusForm').action = `/staf/informasi/${id}`;
        ...
        function goEdit() {
            fetch(`/staf/informasi/${selectedID}/edit`)
                .then(res => res.json())
                .then(data => {
                    ...
                    document.getElementById('editForm').action = `/staf/informasi/${selectedID}`;
